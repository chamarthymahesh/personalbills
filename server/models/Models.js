...
const ConstructionExpenseSchema = new mongoose.Schema({
  date: { type: Date, required: true, default: Date.now },
  amount: { type: Number, required: true },
  category: { type: String, required: true, enum: ['materials', 'labor', 'permits', 'contractor', 'other'] },
...
const PersonalDebtSchema = new mongoose.Schema({
  ...
  personName: { type: String, required: true },
  relationship: { type: String, required: true, enum: ['friend', 'brother', 'relative', 'other'] },
  amount: { type: Number, required: true },
  dateOccurred: { type: Date, required: true, default: Date.now },
  dueDate: { type: Date },
...
const CarMaintenanceSchema = new mongoose.Schema({
  date: { type: Date, required: true, default: Date.now },
  serviceType: { type: String, required: true, enum: ['general_service', 'repair', 'insurance_claim', 'other'] },
